...
export function PaymentStepForm() {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="flex flex-col gap-4 scale-[0.8] absolute w-full max-w-md bg-white p-6 rounded-lg shadow-lg z-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 sm:max-w-[500px] rounded-md shadow-lg p-6">
