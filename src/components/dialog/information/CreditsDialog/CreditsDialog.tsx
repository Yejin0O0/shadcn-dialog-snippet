...
import { InlineDialogDescription, InlineDialogHeader, InlineDialogTitle } from "@/components/ui/inline-dialog";
...
export function CreditsDialog({ type }: CreditsDialogProps) {
  ...
  const DialogDescriptionComponent = type === "fullScreen" ? DialogDescription : InlineDialogDescription;
