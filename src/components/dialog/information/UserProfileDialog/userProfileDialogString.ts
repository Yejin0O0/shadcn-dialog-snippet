export const userProfileDialogString = `import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
      ...
      <DialogContent className="sm:max-w-[450px] rounded-lg shadow-lg p-8 bg-white">
        ...
        >
          <Avatar className="absolute -bottom-12 w-24 h-24 rounded-full border-4 border-white shadow-lg">
            <AvatarImage src="https://avatar.iran.liara.run/public/15" alt="User profile image" />
